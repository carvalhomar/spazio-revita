...
@section('titlePage', 'Controle de conteúdo do blog')
...
@section('buttons-action')
        <a type="button" href="/content/blog/create" class="btn btn-primary my-2 btn-icon-text" data-url="add">
                ...
                <table id="pagetable" class="table table-striped table-bordered text-nowrap dtr-inline">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @csrf
                            <a data-placement="top" data-toggle="tooltip-primary" title="Remover" href="#" onclick="remove(this)" data-id="{{ $data->idblog }}" alt="Remover">
...
@push('scripts')
    ...
    <script src="{{ URL::asset('assets/js/content/blog/custom.js') }}"></script>
@endpush
