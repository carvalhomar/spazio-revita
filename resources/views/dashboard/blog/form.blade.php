...
@section('titlePage', 'Formulário de Conteúdo do Blog')

@section('breadCrumbs')
    <li class="breadcrumb-item" aria-current="page"><a href="/content">Conteúdo</a></li>
    <li class="breadcrumb-item" aria-current="page"><a href="/content/blog">Blog</a></li>
...
@section('content')
    <div class="card custom-card">
        <div class="card-body">
            ...
            <form id="formBlog" method="post" action="" data-parsley-validate novalidate>
                <div class="msg">
                </div>
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control state-valid" name="category_id" id="category_id" required>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" id="description" placeholder="Conteúdo de tratamento" rows="20" required></textarea>
...
@push('scripts')
    ...
    <script src="{{ URL::asset('assets/js/content/blog/form.js') }}"></script>
