...
@section('titlePage', 'Formulário de Saúde')

@section('breadCrumbs')
    <li class="breadcrumb-item" aria-current="page"><a href="/content">Conteúdo</a></li>
    <li class="breadcrumb-item" aria-current="page"><a href="/content/health">Saude</a></li>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="content" id="content" placeholder="Conteúdo de tratamento" required></textarea>
...
@push('scripts')
    ...
    <script src="{{ URL::asset('assets/js/content/health/form.js') }}"></script>
@endpush
