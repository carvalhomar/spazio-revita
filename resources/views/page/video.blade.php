<section id="video" class="aboutus section inverse-bg active">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="section-title text-center mb-4">
                    ...
                    <p class="section-subtitle mx-auto">Conheça nosso canal</p>
        ...
        <div class="row">
            <div class="col-md-6 wow fadeInUp">
                <div class="card" style="width: 35rem; justify-content: center; align-items:center; height: 100%;">
                    <h2>Vídeo 1</h2>
...
{{--                    </a>--}}
            ...
            <div class="col-md-6 wow fadeInUp">
                <div class="card" style="width: 35rem; justify-content: center; align-items:center; height:300;">
                    <h2>Vídeo 2</h2>
